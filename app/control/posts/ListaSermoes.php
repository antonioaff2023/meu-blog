        ...
        public function __construct($param = null)
        {
            ...
            if ($tipo == 1 || $tipo == 2) {
                ...
                if ($tipo == 1) {
                    ...
                    $dv_subtipo->style = 'margin-right: 10px; margin-top: 10px; display: inline-block; width: 30%';
                    $dv_subtipo_lbl = new TLabel('Tipo');
                    $dv_subtipo->add($dv_subtipo_lbl);
            ...
            if ($tipo == 2) {
                $col_id_serie = new TDataGridColumn('serie->nome', 'Série', 'left', '10%');
            ...
            $col_subtipo = new TDataGridColumn('subtipo->descricao', 'Tipo', 'left', '20%');
            ...
            $order_subtipo = new TAction(array($this, 'onReload'), ['id_tipo' => $tipo]);
        ...
        public function onReload($param = null)
        {
            ...
            * ========================= */
                ...
                if ($data) {
                    ...
                    if (!empty($data->tipo)) {
                        $criteria->add(new TFilter('id_tipo', '=', $data->tipo));
                    }
