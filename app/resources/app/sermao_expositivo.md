---
name: gerador-sermao-expositivo-html
description: >
  Gere sermões expositivos em português a partir de um texto bíblico,
  seguindo a estrutura Introdução, Desenvolvimento, Aplicações (3 a 6) e
  Conclusão, usando NAA, e retornando o resultado diretamente em HTML no
  modelo especificado. Use quando o usuário pedir sermão expositivo,
  bosquejo expositivo ou mensagem expositiva com HTML.
---

# Gerador de Sermão Expositivo em HTML

## Quando usar

Use esta habilidade sempre que o usuário pedir:
- sermão expositivo ou mensagem expositiva baseada em um texto bíblico
...
- Explique o texto de forma expositiva, versículo a versículo ou em blocos de versículos.
...
- O desenvolvimento deve ter entre 250 a 350 palavras.
...
<div class="tudo" style="text-align: justify">
  ...
  <h2 style="font-weight: bold;">Aplicações</h2> <!-- Devem ser numeradas em algarismos romanos minúsculo seguido de ')' - Ex.: i)  -->
